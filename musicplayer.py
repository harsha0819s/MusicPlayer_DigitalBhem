...
statusbar = ttk.Label(root, text="Welcome to Famous Music Player", anchor=W, font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to Famous Music Player", anchor=W, font='Arial 8 italic')
...
root.title("Famous Music Player")
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found',
                                         'Famous music player could not find the file. Please select again.')
